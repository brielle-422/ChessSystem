...
public class CircleImageView extends NetworkImageView {
	...
	private static final int DEFAULT_BORDER_WIDTH = 0;// 圆形边框的厚度默认值。
	...
	private BitmapShader mBitmapShader;//实现圆形的属性，
	...
	private void init() {
		super.setScaleType(SCALE_TYPE);//控制图片如何resized/moved来匹对ImageView的size
		mReady = true;
