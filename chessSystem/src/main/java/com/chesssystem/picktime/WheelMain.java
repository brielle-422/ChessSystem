...
//	}
	/**
	 * @Description: TODO 弹出日期时间选择器----无时分
	 */
	public void initDateTimePicker(int year ,int month ,int day) {
	...
	/**
	 * @Description: TODO 弹出日期时间选择器---有时分
	 */
...
//		int day = calendar.get(Calendar.DATE);
		...
		wv_hours = (WheelView)view.findViewById(R.id.wl_hour);
		wv_hours.setVisibility(View.VISIBLE);
		wv_mins = (WheelView)view.findViewById(R.id.wl_min);
