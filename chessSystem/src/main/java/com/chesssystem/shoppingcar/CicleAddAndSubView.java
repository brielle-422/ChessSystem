...
public class CicleAddAndSubView extends LinearLayout {
    ...
    private void initView(){
        View view= LayoutInflater.from(context).inflate(R.layout.layout_goods_choice, null);
        addButton =(ImageView)view.findViewById(R.id.iv_doubleright_add);
        subButton =(ImageView)view.findViewById(R.id.iv_doubleright_reduce);
        editText =(TextView)view.findViewById(R.id.tv_doubleright_number);
        setNum(0);
        addView(view);
    }
    ...
    private class OnButtonClickListener implements OnClickListener{
        ...
        public void onClick(View v){
            ...
            if (TextUtils.isEmpty(numString)){
                ...
                if (v.getId()==R.id.iv_doubleright_add){
                    if (++num < 0){
                        num--;
                        subButton.setVisibility(View.INVISIBLE);
                        editText.setVisibility(View.INVISIBLE);
                        ...
                        if (onNumChangeListener != null){
                            onNumChangeListener.onNumChange(CicleAddAndSubView.this, TYPE_ADD, num);//getNum();
                        }
                    }
                } else if (v.getId()==R.id.iv_doubleright_reduce){
                    if ( --num < 1) {
                        subButton.setVisibility(View.INVISIBLE);
                        editText.setVisibility(View.INVISIBLE);
                        if (onNumChangeListener != null){
                            onNumChangeListener.onNumChange(CicleAddAndSubView.this, TYPE_SUBTRACT, num);
                        }
                    } else{
                        subButton.setVisibility(View.VISIBLE);
                        editText.setVisibility(View.VISIBLE);
