...
import com.chesssystem.album.GirdItemAdapter.OnPhotoSelectedListener;
...
public class SelectPhotoActivity extends Activity {
	...
	private LinearLayout quxiaoBtn;
	...
	public static int maxSize;// 允许最多图片数量
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		maxSize = getIntent().getIntExtra("picNumber", 0);
		setView();
		getImages();
		initEvent();
	}
	...
	private void setView() {
		...
		quxiaoBtn = (LinearLayout) findViewById(R.id.ll_back);
	...
	public void setDataView() {
		...
		girdItemAdapter
				.setOnPhotoSelectedListener(new OnPhotoSelectedListener() {
					// @Override
					...
					// File f=new File(dir,
					// imagename);//localTempImgDir和localTempImageFileName是自己定义的名字
		...
		photoBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (GirdItemAdapter.mSelectedImage.size() > 0) {
					...
					for (String string : GirdItemAdapter.mSelectedImage) {
					...
					Toast.makeText(SelectPhotoActivity.this, "还未选择图片",
							Toast.LENGTH_SHORT).show();
				}
